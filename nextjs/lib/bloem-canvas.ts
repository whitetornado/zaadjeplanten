...
/** Safari/iOS: play() buiten een klik telt niet als gebruikersgebaar.
 *  Eén mute play+pause in een echte klik ontgrendelt het element voor later.
